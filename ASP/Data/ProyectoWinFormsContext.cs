...
namespace ASP.Data
{
    public partial class ProyectoWinFormsContext : DbContext
    {
        public ProyectoWinFormsContext()
        {
        }

        public ProyectoWinFormsContext(DbContextOptions<ProyectoWinFormsContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Data Source=localhost\\SQLEXPRESS;Database=ProyectoWinForms;Trusted_Connection=True");
            }
        }
*/
