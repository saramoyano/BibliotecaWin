...
-- --------------------------------------------------
-- Date Created: 11/08/2019 18:44:59
-- Generated from EDMX file: C:\Users\DAM\source\repos\Grupo2\ProyectoWinForm\AccesoDatos\Model\BibliotecaContext.edmx
-- --------------------------------------------------

SET QUOTED_IDENTIFIER OFF;
GO
USE [ProyectoWinForms];
GO
...
IF OBJECT_ID(N'[dbo].[FK_ClasificacionLibro]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[LibroSet] DROP CONSTRAINT [FK_ClasificacionLibro];
GO
IF OBJECT_ID(N'[dbo].[FK_GeneroLibro]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[LibroSet] DROP CONSTRAINT [FK_GeneroLibro];
GO
IF OBJECT_ID(N'[dbo].[FK_EditorialLibro]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[LibroSet] DROP CONSTRAINT [FK_EditorialLibro];
GO
IF OBJECT_ID(N'[dbo].[FK_UsuarioPrestamo]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[PrestamoSet] DROP CONSTRAINT [FK_UsuarioPrestamo];
GO
IF OBJECT_ID(N'[dbo].[FK_LibroPrestamo]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[PrestamoSet] DROP CONSTRAINT [FK_LibroPrestamo];
GO
...
GO
IF OBJECT_ID(N'[dbo].[EditorialSet]', 'U') IS NOT NULL
    DROP TABLE [dbo].[EditorialSet];
GO
...
GO
IF OBJECT_ID(N'[dbo].[ConfiguracionSet]', 'U') IS NOT NULL
    DROP TABLE [dbo].[ConfiguracionSet];
GO
