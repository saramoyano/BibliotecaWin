...
namespace UWP
{
    ...
    {
        private string connectionString = @"Data Source=localhost\SQLEXPRESS;Persist Security Info=False;Initial Catalog=ProyectoWinForms;Integrated Security=SSPI";
        /// <summary>
